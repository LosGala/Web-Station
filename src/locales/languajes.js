export const languajes = {
  ES: {
    ...
    aboutMe: {
      title: "Sobre Mi",
      description: [
        "Me considero una persona emprendedora, me gusta aprender cosas nuevas todos los días y me motiva la idea de ayudar a los demás haciendo que las cosas funcionen de una manera más fácil y sistemática",
      ...
      data: [
        {
          ...
          description: [
            "Desarrollé un sistema de información para la la empresa PANACEA         utilizando Next.js y TypeScript para el frontend, Tailwind CSS para el diseño de la interfaz de usuario, JSON Web Tokens (JWT) para la autenticación y cookies, y MySQL para la base de datos.",
            "Este sistema de información facilito la informacion de los clientes, empleados y ventas,  lo que les permitió concentrarse en brindar un mejor servicio y aumentar su rentabilidad.",
          ],
          company: "Freelance",
          current: false,
        },
        {
          job: "Aprendiz SENADER - Software Developer",
  ...
  EN: {
    ...
    aboutMe: {
      title: "About Me",
      description: [
        "I consider myself an entrepreneurial person, I like to learn new things every day and I am motivated by the idea of ​​helping others by making things work in an easier and more systematic way.",
      ...
      data: [
        {
          ...
          dates: "Mar 2022 / May 2023",
          description: [
            "I developed an information system for PANACEA  using Next.js and TypeScript for the frontend, Tailwind CSS for the user interface design, JSON Web Tokens (JWT) for authentication and cookies, and MySQL for the database.",
            "This information system enabled to manage customer information, employees, and sales, allowing them to focus on providing better service and increasing profitability.",
          ],
          company: "Freelance",
          current: false,
        },
        {
          job: "SENADER Apprentice - Software Developer",
          dates: "Sept 2022 / Mar 2023",
          description: [
